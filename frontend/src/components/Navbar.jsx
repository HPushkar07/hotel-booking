...
const Navbar = () => {
    ...
    return (
            <nav className={`fixed top-0 left-0 bg-[#2F4F4F] w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50  py-4 md:py-6`}>
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    className="px-8 py-2.5 rounded-full ml-4 transition-all duration-500 bg-white text-black cursor-pointer hover:border-y-blue-300">
                        Login
                    </button>
                    )}  
                </div>
